...
@RestController
@RequestMapping(value="/mItemEmolumentoXmls")
public class MpmItemEmolumentoXmlResource {
	//
	@Autowired
	private MpmItemEmolumentoXmlService mpService;
	
	@RequestMapping(value="/{id}", method=RequestMethod.GET)
	public ResponseEntity<?> findId(@PathVariable Integer id) {
		//
		MpmItemEmolumentoXml mpObj = mpService.buscarId(id);
		//
