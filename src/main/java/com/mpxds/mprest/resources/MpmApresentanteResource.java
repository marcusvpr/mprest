...
@RestController
@RequestMapping(value="/mApresentantes")
public class MpmApresentanteResource {
	//
	@Autowired
	private MpmApresentanteService mpService;
	
	@RequestMapping(value="/{id}", method=RequestMethod.GET)
	public ResponseEntity<?> findId(@PathVariable Integer id) {
		//
		MpmApresentante mpObj = mpService.buscarId(id);
		//
