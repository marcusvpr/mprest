...
@RestController
@RequestMapping(value="/mAtoComposicaos")
public class MpmAtoComposicaoResource {
	//
	@Autowired
	private MpmAtoComposicaoService mpService;
	
	@RequestMapping(value="/{id}", method=RequestMethod.GET)
	public ResponseEntity<?> findId(@PathVariable Integer id) {
		//
		MpmAtoComposicao mpObj = mpService.buscarId(id);
		//
